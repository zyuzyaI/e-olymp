...
s2=0.5*(((yb-ya)*(zs-za)-(zb-za)*(ys-ya))**2+((xb-xa)*(zs-za)-(zb-za)*(xs-xa))**2+((xb-xa)*(ys-ya)-(yb-ya)*(xs-xa))**2)**0.5#ABS
s3=s=0.5*(((yc-yb)*(zs-zb)-(zc-zb)*(ys-yb))**2+((xc-xb)*(zs-zb)-(zc-zb)*(xs-xb))**2+((xc-xb)*(ys-yb)-(yc-yb)*(xs-xb))**2)**0.5#BCS
